...
export default function ContactPage() {
  return (
    <div className="container py-12 space-y-10 text-stone-900">
      <div className="grid gap-8 lg:grid-cols-2 items-start">
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-brand-100/60 p-6 space-y-3 bg-white/80">
            <div>
        ...
        <section id="fit-form" className="rounded-2xl border border-brand-100/60 p-6 bg-white/80 space-y-4">
          <div>
