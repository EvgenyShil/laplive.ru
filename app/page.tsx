...
export default function HomePage() {
  return (
    <div className="container space-y-16 py-12">
      ...
      <section className="rounded-2xl border bg-white/70 p-8 space-y-4">
        ...
        <p className="text-slate-700">Каждая коляска окрашивается в выбранную вами гамму, чтобы подчеркнуть характер хвоста.</p>
      </section>

      <section className="space-y-6">
        <h2 className="text-2xl font-semibold">Как проходит работа</h2>
        <ol className="space-y-4">
          <li className="rounded-2xl border p-5 bg-white/50">
            <h3 className="font-semibold">1. Запрос</h3>
            <p className="text-slate-700">Вы пишете нам, какое животное, сколько весит и какую проблему нужно компенсировать.</p>
          </li>
          <li className="rounded-2xl border p-5 bg-white/50">
            <h3 className="font-semibold">2. Снятие мерок</h3>
            <p className="text-slate-700">Отправляем информацию об измерениях или организуем выезд нашего специалиста.</p>
          </li>
          <li className="rounded-2xl border p-5 bg-white/50">
            <h3 className="font-semibold">3. Материалы и цвет</h3>
            <p className="text-slate-700">Согласовываем материал, упрочнения и цветовую гамму под образ питомца.</p>
          </li>
          <li className="rounded-2xl border p-5 bg-white/50">
            <h3 className="font-semibold">4. 3D‑моделирование и производство</h3>
            <p className="text-slate-700">Создаём 3D‑модель, отправляем фото/рендер изделия и выполняем производство.</p>
          </li>
          <li className="rounded-2xl border p-5 bg-white/50">
            <h3 className="font-semibold">5. Примерка и поддержка</h3>
            <p className="text-slate-700">Приезжаем на примерку, дорабатываем по результатам и остаёмся на связи по всем вопросам.</p>
          </li>
        </ol>
      </section>
