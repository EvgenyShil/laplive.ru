...
const title = 'О DogWheel — команда, подход и технологии колясок для животных';
const description =
  'Команда DogWheel проектирует технологичные коляски в тесной работе с реабилитологами: 3D‑моделирование, подбор материалов и поддержка после примерки.';

export const metadata: Metadata = {
  title,
  description,
  keywords: ['DogWheel', 'коляска для собак', 'реабилитация животных', '3D моделирование коляски'],
  alternates: { canonical: '/about' },
  openGraph: {
    title,
    description,
    url: 'https://dogwheel.ru/about',
    type: 'article'
  }
};
